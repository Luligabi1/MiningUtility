...
public class ItemRegistry {
    ...
    public static final Item MINING_HELMET = initItem("mining_helmet", new ArmorItem(MINING_HELMET_ARMOR_MATERIAL, EquipmentSlot.HEAD, new FabricItemSettings().maxDamage(165)));
